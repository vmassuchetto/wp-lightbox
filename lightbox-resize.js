...
Lightbox.prototype = {
	...
	initialize: function() {	
        ...
        var objBottomNavDownloadForm = document.createElement("form");
        objBottomNavDownloadForm.setAttribute('method', 'POST');
        
        var objBottomNavDownloadFormInput = document.createElement("input");
        objBottomNavDownloadFormInput.setAttribute('type', 'hidden');
        objBottomNavDownloadFormInput.setAttribute('id', 'stimuli_downloadInput');
        objBottomNavDownloadFormInput.setAttribute('name', 'lightbox_download');
        objBottomNavDownloadForm.appendChild(objBottomNavDownloadFormInput);

        var objBottomNavDownloadFormButton = document.createElement("input");
        objBottomNavDownloadFormButton.setAttribute('type', 'submit');
        objBottomNavDownloadFormButton.setAttribute('value', '');
        objBottomNavDownloadFormButton.setAttribute('id', 'stimuli_downloadButton');
        objBottomNavDownloadForm.appendChild(objBottomNavDownloadFormButton);
        
        objBottomNav.appendChild(objBottomNavDownloadForm);
	...
	updateDetails: function() {
        ...
        downloadInput = document.getElementById('stimuli_downloadInput');
        downloadInput.setAttribute('value', imageArray[activeImage][0]);
	},
	//	updateNav()
